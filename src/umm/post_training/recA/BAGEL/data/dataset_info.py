...
DATASET_INFO = {
    ...
    'reconstruction': {
        'webdataset': {
            'data_dir': '/sciclone/data10/yluo13/project/codebase/data/train/data_000000.tar', # path containing all tar files
            ...
            # 'cache_dir': '/sciclone/data10/yluo13/project/codebase/tmp/data_cache', # cache directory for extracted images
        },
    },
}
